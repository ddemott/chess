...
public class King extends Piece {
	...
	public List<Coordinates> getAllPossibleMoves(Board board) {
		...
		List<Coordinates> possibleMoves = rookMoveStratagy.getAllPossibleMoves(board, this, true);

		BishopMoveStratagy bishopMoveStratagy = new BishopMoveStratagy();
		possibleMoves.addAll(bishopMoveStratagy.getAllPossibleMoves(board, this, true));
