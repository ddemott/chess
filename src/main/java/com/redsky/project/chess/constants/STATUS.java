...
public interface STATUS {
	...
	public static final String STARTING_POSITION_NOT_ON_BOARD = "ERROR: Starting postion not on board.";
	...
	public static final String SPACE_STATUS_OCCUPIED_BY_YOUR_OPPONENTS_PIECE = "ERROR: Space is occuppied by your opponent's piece";
